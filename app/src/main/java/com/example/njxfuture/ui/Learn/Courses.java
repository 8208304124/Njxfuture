...
import com.example.njxfuture.databinding.FragmentCoursesBinding;
...
public class Courses extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        Call<List<ArticleDataModel>> call = APIRequests.fetchArticles("860114061759922",7);
    ...
    public void setCustomActionBar() {
        ...
        titleTextView.setText(R.string.courses1);
