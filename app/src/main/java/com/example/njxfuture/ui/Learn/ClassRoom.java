...
import com.example.njxfuture.databinding.FragmentClassRoomBinding;
...
public class ClassRoom extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        listView = binding.classroomList;
        ArticleAdapter adapter = new ArticleAdapter(getContext(), new ArrayList<>()); // Initialize the adapter
        listView.setAdapter(adapter);
        Call<List<ArticleDataModel>> call = APIRequests.fetchArticles("860114061759922",10);
    ...
    public void setCustomActionBar() {
        ...
        titleTextView.setText(R.string.classroom1);
