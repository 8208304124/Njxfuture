...
import com.example.njxfuture.databinding.FragmentMarketBriefBinding;
...
public class MarketBrief extends Fragment {
    ListView listView;
    private FragmentMarketBriefBinding binding;
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentMarketBriefBinding.inflate(inflater, container, false);
        View root = binding.getRoot();
        listView = binding.marketBriefList;
        ArticleAdapter adapter = new ArticleAdapter(getContext(), new ArrayList<>()); // Initialize the adapter
        listView.setAdapter(adapter);
        Call<List<ArticleDataModel>> call = APIRequests.fetchArticles("860114061759922",8);
    ...
    public void setCustomActionBar() {
        ...
        titleTextView.setText(R.string.market_brief1);
