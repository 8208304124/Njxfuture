...
import com.example.njxfuture.databinding.FragmentMediaBinding;
...
public class Media extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<List<ArticleDataModel>> call = APIRequests.fetchArticles("860114061759922",3);
    ...
    public void setCustomActionBar() {
        ...
        titleTextView.setText(R.string.media1);
