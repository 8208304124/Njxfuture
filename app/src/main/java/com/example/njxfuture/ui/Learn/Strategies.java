...
public class Strategies extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        listView = binding.strategiesList;
        ArticleAdapter adapter = new ArticleAdapter(getContext(), new ArrayList<>()); // Initialize the adapter
        listView.setAdapter(adapter);
        Call<List<ArticleDataModel>> call = APIRequests.fetchArticles("860114061759922",5);
    ...
    public void setCustomActionBar() {
        ...
        titleTextView.setText(R.string.strategies1);
