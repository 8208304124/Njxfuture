...
import com.example.njxfuture.databinding.FragmentOptionClubBinding;
...
public class OptionClub extends Fragment {

    ListView listView;
    private FragmentOptionClubBinding binding;
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentOptionClubBinding.inflate(inflater, container, false);
        View root = binding.getRoot();
        listView = binding.optionClubList;
        ArticleAdapter adapter = new ArticleAdapter(getContext(), new ArrayList<>()); // Initialize the adapter
        listView.setAdapter(adapter);
        Call<List<ArticleDataModel>> call = APIRequests.fetchArticles("860114061759922",9);
    ...
    public void setCustomActionBar() {
        ...
        titleTextView.setText(R.string.option_club1);
