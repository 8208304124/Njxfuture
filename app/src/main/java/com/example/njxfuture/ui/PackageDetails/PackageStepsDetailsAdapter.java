...
public class PackageStepsDetailsAdapter extends ArrayAdapter<Step> {

    private final Context context;
    List<Step> packageActions;
    public PackageStepsDetailsAdapter(Context context, List<Step> packageActions) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (view != null) {
            ...
            textView.setText(packageActions.get(position).getStep());
        }
        return view;
    }
}
