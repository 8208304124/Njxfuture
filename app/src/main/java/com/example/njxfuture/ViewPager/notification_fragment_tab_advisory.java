...
import com.example.njxfuture.databinding.FragmentNotificationTabAdvisoryBinding;
...
public class notification_fragment_tab_advisory extends Fragment {
    ...
    private @NonNull FragmentNotificationTabAdvisoryBinding binding;
    ListView listView;
    private ProgressBar progressBar;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentNotificationTabAdvisoryBinding.inflate(inflater, container, false);
        View root = binding.getRoot();
        progressBar = root.findViewById(R.id.progressBar);
        showLoader();
        listView = binding.advisoryList;
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://www.moneycontrol.com/rss/")
                .addConverterFactory(SimpleXmlConverterFactory.create())
                .build();
        RSSClient.RSSService3 service = retrofit.create(RSSClient.RSSService3.class);
